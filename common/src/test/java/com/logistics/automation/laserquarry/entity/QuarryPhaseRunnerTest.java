...
class QuarryPhaseRunnerTest {
    ...
    void phaseStateSurvivesSaveLoadRoundTrip() {
        ...
        assertThat(resaved.getInt("FrameBuildIndex").orElseThrow()).isEqualTo(42);
        assertThat(resaved.getInt("FrameRepairIndex").orElseThrow()).isEqualTo(7);
        assertThat(resaved.getInt("FrameScanIndex").orElseThrow()).isEqualTo(9);
        assertThat(resaved.getInt("ClearanceIndex").orElseThrow()).isEqualTo(11);
    }
    ...
    void customBoundsResetRestartsFullSequence() {
        ...
        assertThat(saved.getInt("FrameRepairIndex").orElseThrow()).isZero();
        assertThat(saved.getInt("FrameScanIndex").orElseThrow()).isZero();
        assertThat(saved.getInt("ClearanceIndex").orElseThrow()).isZero();
    }
}
