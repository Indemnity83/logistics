...
public class MagmaticRecipeCategory implements IRecipeCategory<MagmaticFuelDisplay> {
    ...
    public static final IRecipeType<MagmaticFuelDisplay> RECIPE_TYPE =
        IRecipeType.create(LogisticsMod.MOD_ID, "magmatic", MagmaticFuelDisplay.class);
    ...
    @Override
    public IRecipeType<MagmaticFuelDisplay> getRecipeType() {
        return RECIPE_TYPE;
    }
