...
public class ModuleGameTestBody {
    ...
    private static PipeBlockEntity buildFilterJunction(GameTestHelper context) {
        ...
        PipeBlockEntity filterEntity = (PipeBlockEntity) context.getBlockEntity(FILTER_PIPE);
        ...
        PipeBlockEntity entry = (PipeBlockEntity) context.getBlockEntity(FILTER_ENTRY);
        if (entry == null) {
