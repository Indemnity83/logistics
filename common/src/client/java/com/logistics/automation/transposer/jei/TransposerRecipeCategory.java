...
public class TransposerRecipeCategory implements IRecipeCategory<TransposerRecipe> {
    ...
    public static final RecipeType<TransposerRecipe> RECIPE_TYPE =
        RecipeType.create(LogisticsMod.MOD_ID, "transposer", TransposerRecipe.class);
    ...
    @Override
    public RecipeType<TransposerRecipe> getRecipeType() {
        return RECIPE_TYPE;
    }
    ...
    @Override
    public void draw(TransposerRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, TransposerRecipe recipe, IFocusGroup focuses) {
        ...
        recipe.result().ifPresent(result ->
            builder.addSlot(RecipeIngredientRole.OUTPUT, ITEM_OUT_X, ITEM_OUT_Y).addItemStack(result.toStack()));
