...
public final class PipeModelResolver {
    ...
    public static List<Layer> resolve(String modelBase) {
        ...
        // NOTE (mc/1.21.1): the #469 power-status overlays (logistics_pipe_arm_overlay /
        // logistics_pipe_core_overlay) are intentionally omitted — those textures and the
        // green/red power tint are not on this branch. Logistics pipes render single-layer with
        // their existing textures, matching the pre-#469 look. If #469 is ever ported here, restore
        // the two logistics-overlay branches (and their textures).
