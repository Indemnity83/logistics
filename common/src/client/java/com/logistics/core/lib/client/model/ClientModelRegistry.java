 ...
 * BakedModel model = ClientModelRegistry.get(LogisticsPowerClient.MODEL.BELLOW);
 *
...
public final class ClientModelRegistry {
    ...
    /** Loader callback that resolves a {@link ModelKey} to a baked {@link BakedModel}. */
    @FunctionalInterface
    public interface Provider {
        @Nullable
        BakedModel get(ModelKey key);
    }
     ...
     */
    @Nullable
    public static BakedModel get(ModelKey key) {
