<div class="infobox">
    ...
    <div class="infobox-image">
        <img src="../../assets/icons/logistics__core___valve_obsidian.png" alt="Obsidian Valve" title="Obsidian Valve">
    </div>
...
<div class="crafting-recipe">
    <div class="crafting-grid">
        ...
        <div class="crafting-slot"><img src="../../assets/icons/minecraft__obsidian.png" class="crafting-item" alt="Obsidian" title="Obsidian"></div>
        <div class="crafting-slot"></div>
    ...
    <div class="crafting-output">
        <a href="../valve-obsidian/"><img src="../../assets/icons/logistics__core___valve_obsidian.png" class="crafting-item" alt="Obsidian Valve" title="Obsidian Valve"></a>
