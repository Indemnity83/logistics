...
@DisplayName("ContainerInsert.insertIntoSlot")
class ContainerInsertTest extends MinecraftTestEnvironment {
    ...
    void insertsIntoEmptySlot() {
        ...
        ItemStack remainder = ContainerInsert.insertIntoSlot(container, 0, stack);
    ...
    void marksChangedWhenInsertingIntoEmptySlot() {
        ...
        ContainerInsert.insertIntoSlot(container, 0, stack);
