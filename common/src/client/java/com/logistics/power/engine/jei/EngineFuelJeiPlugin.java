...
public class EngineFuelJeiPlugin implements IModPlugin {
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        ...
        registration.addRecipeCatalyst(LogisticsPower.BLOCK.STIRLING_ENGINE, RecipeTypes.FUELING);
        registration.addRecipeCatalyst(LogisticsPower.BLOCK.STEAM_ENGINE, RecipeTypes.FUELING);
    }
}
