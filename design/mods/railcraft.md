...
| Steam Turbine / steam engines | Steam → RF/work | Modernize | Shipped ahead of Phase 3: a first-party single-block **Steam Engine** (v0.8.4, boiler/pressure/turbine model) is already in the engine line. The Create-compat plan was preempted — see [RFC 0003](../rfcs/0003-railcraft-multiblocks.md) | ✅ Done | `power` / Steam Engine |
