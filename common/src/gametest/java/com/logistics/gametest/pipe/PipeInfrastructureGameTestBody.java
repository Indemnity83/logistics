...
public class PipeInfrastructureGameTestBody {
    ...
    public static void testMultiplePipeTypes(GameTestHelper context) {
        ...
        if ((PipeBlockEntity) context.getBlockEntity(new BlockPos(0, 1, 0)) == null) {
            context.fail("Stone pipe should have block entity");
            return;
        }
        if ((PipeBlockEntity) context.getBlockEntity(new BlockPos(1, 1, 0)) == null) {
            context.fail("Copper pipe should have block entity");
            return;
        }
        if ((PipeBlockEntity) context.getBlockEntity(new BlockPos(2, 1, 0)) == null) {
            context.fail("Filter pipe should have block entity");
            return;
        }
        if ((PipeBlockEntity) context.getBlockEntity(new BlockPos(3, 1, 0)) == null) {
