...
| `neoforge` | `neoforge/src/gametest/java/` | Feature | NeoForge `@GameTestHolder` annotation scanning (see below) |
...
`// not-yet-shared:` backlog — so Fabric wires 213 methods and NeoForge 210. Read the *difference*
rather than either total: 3, exactly the unshared Fabric set, and expected rather than a defect.
