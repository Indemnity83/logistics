...
public class LogisticsMod implements ModInitializer {
	...
	public void onInitialize() {
		...
		TimingLog.time(LOGGER, "ItemStorage.SIDED.registerForBlockEntity", () -> ItemStorage.SIDED.registerForBlockEntity(
		...
		ServerLifecycleEvents.SERVER_STARTED.register(server -> TimingLog.logSince(LOGGER, "server_starting", "Server starting"));
