...
/**
 * Shared Alloy Smelter GameTest bodies, compiled directly into both loaders' {@code gametest}
 ...
 * {@code AlloySmelterGameTest} delegates to these methods, and NeoForge's
 * {@code AlloySmelterGameTestRegistration} references them directly as
 * {@code Consumer<GameTestHelper>} method references.
 */
public class AlloySmelterGameTestBody {
