...
[![codecov](https://codecov.io/gh/Indemnity83/logistics/branch/mc%2F1.21.1/graph/badge.svg)](https://codecov.io/gh/Indemnity83/logistics)
...
**Requirements:** Minecraft 1.21.1 • Fabric (with Fabric API) or NeoForge • Java 21+
...
**Requirements:** JDK 21 and Git. The Gradle wrapper (`./gradlew`) handles everything else.
