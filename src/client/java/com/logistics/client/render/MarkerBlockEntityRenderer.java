...
public class MarkerBlockEntityRenderer implements BlockEntityRenderer<MarkerBlockEntity, MarkerRenderState> {
    private static final Identifier BEAM_MODEL_ID = Identifier.of(LogisticsMod.MOD_ID, "block/marker_beam");
    ...
    public void render(
        ...
        BlockStateModel beamModel = PipeModelRegistry.getModel(BEAM_MODEL_ID);
        if (beamModel == null) {
            return;
        }
