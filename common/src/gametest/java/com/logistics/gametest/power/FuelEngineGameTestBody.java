...
/**
 * Shared fuel engine GameTest bodies, compiled directly into both loaders' {@code gametest}
 ...
 * {@code FuelEngineGameTest} delegates to these methods, and NeoForge's
 * {@code FuelEngineGameTestRegistration} references them directly as
 * {@code Consumer<GameTestHelper>} method references.
 */
public class FuelEngineGameTestBody {

    private static Fluid crudeOil() {
        return BuiltInRegistries.FLUID.getValue(LogisticsCore.resource("crude_oil").toIdentifier());
    }
    ...
    private static FuelEngineBlockEntity placePowered(GameTestHelper context, BlockPos pos) {
        ...
        return context.getBlockEntity(pos, FuelEngineBlockEntity.class);
    }
    ...
    public static void testFuelEngineGeneratesFromFuel(GameTestHelper context) {
        ...
        context.runAfterDelay(20, () -> {
            FuelEngineBlockEntity e = context.getBlockEntity(pos, FuelEngineBlockEntity.class);
    ...
    public static void testFluidInsertRoutesByType(GameTestHelper context) {
        BlockPos pos = new BlockPos(0, 1, 0);
        context.setBlock(pos, LogisticsPower.BLOCK.FUEL_ENGINE);
        FuelEngineBlockEntity engine = context.getBlockEntity(pos, FuelEngineBlockEntity.class);
