...
class QuarryFrameRepairTest extends MinecraftTestEnvironment {
    ...
    void clearanceCursorSurvivesSaveAndLoad() {
        ...
        runner.save(written);
        assertThat(written.getInt("ClearanceIndex")).isEqualTo(91);
    }
    ...
    void repairSurvivesSaveAndLoad() {
        ...
        CompoundTag written = new CompoundTag();
        runner.save(written);
        assertThat(written.getString("CurrentPhase")).isEqualTo(QuarryPhase.REPAIRING_FRAME.name());
        assertThat(written.getInt("FrameRepairIndex")).isEqualTo(7);
        assertThat(written.getInt("FrameScanIndex")).isEqualTo(3);
    }
    ...
    void oldSaveLoadsCleanly() {
        ...
        CompoundTag written = new CompoundTag();
        runner.save(written);
        assertThat(written.getInt("FrameRepairIndex")).isEqualTo(0);
        assertThat(written.getInt("FrameScanIndex")).isEqualTo(0);
    }
