...
class QuarryBoundsTest extends MinecraftTestEnvironment {
    ...
    void usesExistingNbtKeys() {
        ...
        assertThat(tag.getBoolean("UseCustomBounds")).isTrue();
        assertThat(tag.getInt("CustomBoundsMinX")).isEqualTo(1);
        assertThat(tag.getInt("CustomBoundsMinZ")).isEqualTo(2);
        assertThat(tag.getInt("CustomBoundsMaxX")).isEqualTo(3);
        assertThat(tag.getInt("CustomBoundsMaxZ")).isEqualTo(4);
    }
    ...
    void omitsBoundValuesWhenNotCustom() {
        ...
        assertThat(tag.getBoolean("UseCustomBounds")).isFalse();
