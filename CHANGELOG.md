...
* **energy:** batteries on one cable level out ([#1257](https://github.com/Indemnity83/logistics/issues/1257)) ([bb56aa6](https://github.com/Indemnity83/logistics/commit/bb56aa6df37c880fd430997ccae7a6ff1240c811))
* **energy:** let the logistics network drain a Power Junction without a rate cap ([#1263](https://github.com/Indemnity83/logistics/issues/1263)) ([f16ebcb](https://github.com/Indemnity83/logistics/commit/f16ebcb79bc232642f61e46d038edee4f57a4869))


### Fixed

* **energy:** empty a battery bank evenly instead of one at a time ([#1256](https://github.com/Indemnity83/logistics/issues/1256)) ([462b6e6](https://github.com/Indemnity83/logistics/commit/462b6e6c6c11bc55d6d3abf12b2c7c5a0c384077))
* **energy:** serve machines before batteries on a cable ([#1255](https://github.com/Indemnity83/logistics/issues/1255)) ([81555b2](https://github.com/Indemnity83/logistics/commit/81555b2391349b6391421cde85d1654822e5f381))
* **energy:** stop a cable draining the Power Junction ([#1253](https://github.com/Indemnity83/logistics/issues/1253)) ([2edc9a6](https://github.com/Indemnity83/logistics/commit/2edc9a651bc223f71577b72442a5ef0beb2701a9))

## [0.8.9](https://github.com/Indemnity83/logistics/compare/mc26.2-v0.8.8...mc26.2-v0.8.9) (2026-09-21)


### Added

* **automation:** let sawdust burn as furnace fuel ([ffe9610](https://github.com/Indemnity83/logistics/commit/ffe9610341ed7b2e7c8f23fae9f30cffd871f5b4))
* **common:** show ores, machines and oil lakes on maps ([fa238be](https://github.com/Indemnity83/logistics/commit/fa238be1d44e43031b81d790d92e58de8004c022))
* **fluids:** comparators read a tank column's fill level ([8555c14](https://github.com/Indemnity83/logistics/commit/8555c146ecaa02c18c66a4858f08672a89175bb3))
* **quarry:** keep the cleared area clear while mining ([c171eda](https://github.com/Indemnity83/logistics/commit/c171edaec7375d16f3a6f3391c6813719c629ba1))
* **quarry:** rebuild frame blocks broken during mining ([c171eda](https://github.com/Indemnity83/logistics/commit/c171edaec7375d16f3a6f3391c6813719c629ba1))
* **routing:** recover stranded packets onto live orders ([526ea67](https://github.com/Indemnity83/logistics/commit/526ea6758cb5a810db6bbbc9985a1704f5cc1c89))


### Changed

* **automation:** require a stone pickaxe for the Quarry and Power Junction ([438e9f4](https://github.com/Indemnity83/logistics/commit/438e9f474fe19b03cd6b8d90ebdfb43ae7dc8bab))
* **energy:** scan cable devices once per tick ([026c428](https://github.com/Indemnity83/logistics/commit/026c42832bff03589d99ce036924a40cc1355950))
* **routing:** protect the Provider's named slot by index ([c33de60](https://github.com/Indemnity83/logistics/commit/c33de60251420ede8c308d47eb99fb37f0297cca))
* **routing:** stop availability scans slowing as reservations pile up ([334f95f](https://github.com/Indemnity83/logistics/commit/334f95f411b1251a4751d45cbdc6fee0735ab619))


### Fixed

* **automation:** scale the Crucible gauge by the server's tank size ([93d8762](https://github.com/Indemnity83/logistics/commit/93d87620b0a22f7a2e8d4bc88532d650e24e4914))
* **common:** stop pickaxes destroying blocks they should harvest ([438e9f4](https://github.com/Indemnity83/logistics/commit/438e9f474fe19b03cd6b8d90ebdfb43ae7dc8bab))
* **core:** stop stale machine textures after a resource reload ([507b8fe](https://github.com/Indemnity83/logistics/commit/507b8fe366843d9dd19513aa3f09da897875f429))
* **crafting:** report a malformed byproduct chance as a recipe error ([a9e4724](https://github.com/Indemnity83/logistics/commit/a9e4724506a7b169f64fbaaa201c0701b5608588))
* **energy:** power the new network right after a pipe split ([7caa48b](https://github.com/Indemnity83/logistics/commit/7caa48be3c0707e7f75c113a37d1a27ec06f718b))
* **energy:** scale the Stirling charge gauge to the buffer size ([161714a](https://github.com/Indemnity83/logistics/commit/161714a53273a6dc4e40a6b360102204456b23a8))
* **energy:** stop batteries draining each other ([#1242](https://github.com/Indemnity83/logistics/issues/1242)) ([4b23f3a](https://github.com/Indemnity83/logistics/commit/4b23f3aeb45f4acfad0fb8c93f2fe0a3be20c969))
* **energy:** stop cables drawing a wrong connection arm ([bdbfc39](https://github.com/Indemnity83/logistics/commit/bdbfc3929d20903ec8fe2d2aac216383ddee5a86))
* **fluids:** show correct tank amounts above 32,767 mB ([f78b905](https://github.com/Indemnity83/logistics/commit/f78b905ddb7437a73345de91ea1c75ef94da2a85))
* **neoforge:** report a wrapped mod inventory's real slot capacity ([f7def7a](https://github.com/Indemnity83/logistics/commit/f7def7ad0948d032c3863a3e1de18385991e229c))
* **quarry:** animate the arm at the real tick rate ([c533674](https://github.com/Indemnity83/logistics/commit/c5336748b1897f97fa20d4a0cd93d44b51aed9e4))
* **quarry:** pick up loose items around the laser head ([#1241](https://github.com/Indemnity83/logistics/issues/1241)) ([519f6ad](https://github.com/Indemnity83/logistics/commit/519f6ad6ad073a7456f1d03f4f3776264112d01a))
* **quarry:** resume block break progress after a reload ([2f4cc5e](https://github.com/Indemnity83/logistics/commit/2f4cc5eb03fd8a327fc525a49434d8ba03b38e0f))
* **routing:** send items and fluids to the nearest matching destination ([43e7bee](https://github.com/Indemnity83/logistics/commit/43e7beec95856c5ea3bade5c8b3a830faa6a925d))
* **ui:** show the server's config values on multiplayer clients ([197f7ca](https://github.com/Indemnity83/logistics/commit/197f7ca20b92548575c4548e4d46f10f139ad343))
* **worldgen:** stop oil seeps erasing nearby oil deposits ([#1180](https://github.com/Indemnity83/logistics/issues/1180)) ([af6b5ce](https://github.com/Indemnity83/logistics/commit/af6b5ceded7bff6e56208c122a02ed0e6b4c0f43))
...
* **energy:** stop idle engines resaving their chunks every tick ([c5e4b60](https://github.com/Indemnity83/logistics/commit/c5e4b60f2a7ba60c1ace69679ba6a20109476f3d))
* **fluids:** stop tank columns rewriting cells that did not change ([c5e4b60](https://github.com/Indemnity83/logistics/commit/c5e4b60f2a7ba60c1ace69679ba6a20109476f3d))
* **routing:** make the MkIII Extractor a real upgrade ([75be9f9](https://github.com/Indemnity83/logistics/commit/75be9f912b04ad5c7b005d754907d8f8df171422))
* **routing:** rank specific Item Sinks above Polymorphic ([84283a6](https://github.com/Indemnity83/logistics/commit/84283a6f74ba2303d920bbc2355a09074cd199ee))
...
* **automation:** let a stalled Fabricator order be cancelled ([1df337d](https://github.com/Indemnity83/logistics/commit/1df337d526fd9fb3d9c90d4933f6e626190acf74))
* **automation:** stop a new quarry inheriting the old one's arm position ([27f3dd1](https://github.com/Indemnity83/logistics/commit/27f3dd18beaa31e0b8e17d1ad2e8ec9cb646d39c))
* **automation:** stop machines jamming on items they cannot use ([ec1a98c](https://github.com/Indemnity83/logistics/commit/ec1a98ca3c4c550ccc8393eda50d7716eb2e12bb))
...
* **automation:** stop the Fabricator eating a failed craft ([643f4b0](https://github.com/Indemnity83/logistics/commit/643f4b0196b536dbca5b9a06c97f7bf2f71d8ef1))
...
* **core:** reject config values that silently brick a machine ([10df166](https://github.com/Indemnity83/logistics/commit/10df166dd8a5041fb1540db2875a79b0e67448d8))
...
* **energy:** hold the battery's per-side push to its own I/O ceiling ([10df166](https://github.com/Indemnity83/logistics/commit/10df166dd8a5041fb1540db2875a79b0e67448d8)), closes [#992](https://github.com/Indemnity83/logistics/issues/992) [#982](https://github.com/Indemnity83/logistics/issues/982) [#995](https://github.com/Indemnity83/logistics/issues/995) [#1000](https://github.com/Indemnity83/logistics/issues/1000)
...
* **energy:** stop a legal steam config making RF free ([10df166](https://github.com/Indemnity83/logistics/commit/10df166dd8a5041fb1540db2875a79b0e67448d8))
* **energy:** stop a new engine resuming the old one's piston stroke ([27f3dd1](https://github.com/Indemnity83/logistics/commit/27f3dd18beaa31e0b8e17d1ad2e8ec9cb646d39c)), closes [#976](https://github.com/Indemnity83/logistics/issues/976) [#988](https://github.com/Indemnity83/logistics/issues/988)
* **energy:** stop cables exceeding their throughput cap ([02af441](https://github.com/Indemnity83/logistics/commit/02af4410bce8487d73314329696a5369f5b69c4b))
...
* **energy:** stop the Magmatic Engine locking itself out of ignition ([10df166](https://github.com/Indemnity83/logistics/commit/10df166dd8a5041fb1540db2875a79b0e67448d8))
...
* **pipes:** re-request deliveries that time out in transit ([71772d5](https://github.com/Indemnity83/logistics/commit/71772d55bba7fe3d5b4d59c627789a6346a495c7))
...
* **routing:** detach chassis modules shift-clicked out ([b915ff9](https://github.com/Indemnity83/logistics/commit/b915ff9318cae9f8d4aa6f1dd17a9d0ee8c4a8f4))
...
* **routing:** keep chassis sinks working after a network split ([57453c8](https://github.com/Indemnity83/logistics/commit/57453c8e4fb17ce6e98516c4c38fe3f9d73ee2b4))
* **routing:** make tied sink priorities pick a stable destination ([84283a6](https://github.com/Indemnity83/logistics/commit/84283a6f74ba2303d920bbc2355a09074cd199ee))
...
* **routing:** stop Providers draining the slot they reserve ([87476f3](https://github.com/Indemnity83/logistics/commit/87476f3e8a183b7d4b7b9154161de08dd3bc80f6))
* **routing:** stop Supplier slots editing the wrong entry ([568069e](https://github.com/Indemnity83/logistics/commit/568069ece8b19104e73d7482c379252e15010948))
* **routing:** stop Suppliers forgetting their stock target ([1886c4f](https://github.com/Indemnity83/logistics/commit/1886c4fcc4babb26851a9680982a8e37e5c94866))
* **routing:** stop the MkIII Extractor pulling less than the MkII ([75be9f9](https://github.com/Indemnity83/logistics/commit/75be9f912b04ad5c7b005d754907d8f8df171422))
...
* **storage:** report a real item capacity to other mods ([74bc524](https://github.com/Indemnity83/logistics/commit/74bc52461d51b19e60d878d3f27d8c181e1b60fd)), closes [#985](https://github.com/Indemnity83/logistics/issues/985) [#986](https://github.com/Indemnity83/logistics/issues/986) [#990](https://github.com/Indemnity83/logistics/issues/990)
* **transport:** apply config reloads to stone and gold pipes ([4b4a1e4](https://github.com/Indemnity83/logistics/commit/4b4a1e440b21f186f6f7f797d349d870b94db919))
...
* **ui:** close machine screens when the machine is gone ([1679aeb](https://github.com/Indemnity83/logistics/commit/1679aebf6c4e82f421be402b06dac0221b6df446))
* **ui:** show byproduct guaranteed count in JEI ([729ae31](https://github.com/Indemnity83/logistics/commit/729ae312c35dec0205f07a16734a4016fc939151))
* **ui:** stop listing every automation recipe twice in JEI ([f163a5f](https://github.com/Indemnity83/logistics/commit/f163a5f3ff9a90e6b5bead23991a20157818b98b))
...
* **automation:** add crude oil to petroleum-block transposer recipes ([#851](https://github.com/Indemnity83/logistics/issues/851)) ([9d5fe2b](https://github.com/Indemnity83/logistics/commit/9d5fe2b5fd2c97f1ab91c7c647e7e338b20f9289))
* **automation:** add RF cost and recipe system to the Transposer ([#829](https://github.com/Indemnity83/logistics/issues/829)) ([65194ae](https://github.com/Indemnity83/logistics/commit/65194ae1659522de7f62e649651e625360144530))
* **automation:** add stone, concrete, cactus, and seed-oil Transposer recipes ([65194ae](https://github.com/Indemnity83/logistics/commit/65194ae1659522de7f62e649651e625360144530))
* **core:** add shared gear recipe tags ([#871](https://github.com/Indemnity83/logistics/issues/871)) ([2989ccc](https://github.com/Indemnity83/logistics/commit/2989ccc1377c1baff495a9777e890f765178aa0e))
* **energy:** show engine fuels in the recipe browser ([#886](https://github.com/Indemnity83/logistics/issues/886)) ([c27fb39](https://github.com/Indemnity83/logistics/commit/c27fb392e64de6d0ed0d5135ecad9ae5099ecbd7))
* **fluids:** drain cauldrons with the fluid extractor pipe ([#885](https://github.com/Indemnity83/logistics/issues/885)) ([6a6d908](https://github.com/Indemnity83/logistics/commit/6a6d9081621b6fbc70ec6933ab7bfd639aef4d3c))


### Changed

* **automation:** restyle the Crucible progress gauge as a droplet ([#834](https://github.com/Indemnity83/logistics/issues/834)) ([bde1374](https://github.com/Indemnity83/logistics/commit/bde1374e5a46e6e79e64b5c07bfb3093a9811a0f))
* **automation:** swap side buckets for glass in the Transposer recipe ([65194ae](https://github.com/Indemnity83/logistics/commit/65194ae1659522de7f62e649651e625360144530))


### Fixed

* **automation:** accept raw ore in the quicksilver amalgamation recipes ([#840](https://github.com/Indemnity83/logistics/issues/840)) ([35a926c](https://github.com/Indemnity83/logistics/commit/35a926cc90370036478222cfe8a31732a37311b0))
* **automation:** stop refinery shift-click from duplicating items ([#846](https://github.com/Indemnity83/logistics/issues/846)) ([e72c218](https://github.com/Indemnity83/logistics/commit/e72c218ae4f656496742b305a02b144f551425ff))
* **compat:** stop Jade plugin error on dedicated servers ([#878](https://github.com/Indemnity83/logistics/issues/878)) ([659dd01](https://github.com/Indemnity83/logistics/commit/659dd01b5047c314e743b0766e677c18051ad3ad))
* **energy:** add catalyst engine JEI category ([#874](https://github.com/Indemnity83/logistics/issues/874)) ([e93d5c3](https://github.com/Indemnity83/logistics/commit/e93d5c356d8a8665b246ac81787ab63d04431f51))
* **energy:** show the reaction engine's recipes in JEI on Fabric ([#886](https://github.com/Indemnity83/logistics/issues/886)) ([c27fb39](https://github.com/Indemnity83/logistics/commit/c27fb392e64de6d0ed0d5135ecad9ae5099ecbd7))
* **energy:** stop battery and cable taking forever to mine ([#839](https://github.com/Indemnity83/logistics/issues/839)) ([66d6e29](https://github.com/Indemnity83/logistics/commit/66d6e29ef9e69b30f4056b173618993e9dd54268))
* **fluids:** honor pipe transfer rates set above the default ([#885](https://github.com/Indemnity83/logistics/issues/885)) ([6a6d908](https://github.com/Indemnity83/logistics/commit/6a6d9081621b6fbc70ec6933ab7bfd639aef4d3c))
* **fluids:** obscure vision and apply Nausea/Poison/Slowness in Crude Oil ([#848](https://github.com/Indemnity83/logistics/issues/848)) ([0e9471c](https://github.com/Indemnity83/logistics/commit/0e9471c892fbd787f12a7bd2607cbbc401302e9d))
* **fluids:** stop over-capacity saved tank amounts from crashing on load ([#849](https://github.com/Indemnity83/logistics/issues/849)) ([e675697](https://github.com/Indemnity83/logistics/commit/e675697a703b18798979e58f2301843349455d53))
* **macerator:** grind loose raw ore items into dust ([#838](https://github.com/Indemnity83/logistics/issues/838)) ([43a9cb9](https://github.com/Indemnity83/logistics/commit/43a9cb9c7b960748361d0d95b6797dc5c28600b6))
* **quarry:** stop the arm mining through lava or ignoring reappeared blocks ([#850](https://github.com/Indemnity83/logistics/issues/850)) ([ce3eb60](https://github.com/Indemnity83/logistics/commit/ce3eb6005e47dfab0108218fb598dab6bf23917a))
* **routing:** treat requester deliveries with no inventory as fulfilled ([#847](https://github.com/Indemnity83/logistics/issues/847)) ([0cdb4c1](https://github.com/Indemnity83/logistics/commit/0cdb4c1af0413009d3c3d4eb7506b8eacb04a20e))
