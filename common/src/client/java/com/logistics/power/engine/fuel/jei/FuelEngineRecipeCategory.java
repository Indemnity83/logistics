...
public class FuelEngineRecipeCategory implements IRecipeCategory<FuelEngineFuels.Entry> {
    ...
    public static final RecipeType<FuelEngineFuels.Entry> RECIPE_TYPE =
        RecipeType.create(LogisticsMod.MOD_ID, "fuel_engine", FuelEngineFuels.Entry.class);
    ...
    @Override
    public RecipeType<FuelEngineFuels.Entry> getRecipeType() {
        return RECIPE_TYPE;
    }
