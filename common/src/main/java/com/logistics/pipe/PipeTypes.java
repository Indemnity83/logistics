...
public final class PipeTypes {
    ...
    public static final ItemPipe STONE_TRANSPORT_PIPE =
            new ItemPipe(new TransportModule(LogisticsConfigHost.get(Configs.PIPE_MIN_SPEED), LogisticsConfigHost.get(Configs.PIPE_DRAG))) {};
    ...
    public static final ItemPipe GOLD_TRANSPORT = new ItemPipe(new BoostModule(LogisticsConfigHost.get(Configs.PIPE_ACCELERATION))) {};
