...
* **energy:** batteries on one cable level out ([#1257](https://github.com/Indemnity83/logistics/issues/1257)) ([442f00e](https://github.com/Indemnity83/logistics/commit/442f00e01430ba8b50f15d9e70c22fd3f38899f2))
* **energy:** let the logistics network drain a Power Junction without a rate cap ([#1263](https://github.com/Indemnity83/logistics/issues/1263)) ([f64385b](https://github.com/Indemnity83/logistics/commit/f64385b0f7163daec6a3a9dd6c06b51cc8a815f6))


### Fixed

* **energy:** empty a battery bank evenly instead of one at a time ([#1256](https://github.com/Indemnity83/logistics/issues/1256)) ([bcca3a4](https://github.com/Indemnity83/logistics/commit/bcca3a4dbe5bcfacedcb042115bc1ebc57707448))
* **energy:** serve machines before batteries on a cable ([#1255](https://github.com/Indemnity83/logistics/issues/1255)) ([79dacf2](https://github.com/Indemnity83/logistics/commit/79dacf2b6a3a4e3a772c60e2b47240b10c28c3b8))
* **energy:** stop a cable draining the Power Junction ([#1253](https://github.com/Indemnity83/logistics/issues/1253)) ([e50559b](https://github.com/Indemnity83/logistics/commit/e50559bc9300221cfdaa6d5664e71dfd5c6871a6))

## [0.8.9](https://github.com/Indemnity83/logistics/compare/mc1.21.11-v0.8.8...mc1.21.11-v0.8.9) (2026-09-21)


### Added

* **automation:** let sawdust burn as furnace fuel ([8064c7c](https://github.com/Indemnity83/logistics/commit/8064c7c89cdcf94a18a171305787ce63e395d7dd))
* **common:** show ores, machines and oil lakes on maps ([449debb](https://github.com/Indemnity83/logistics/commit/449debbe98b5dccd6a442428f4df2672c424ccd7))
* **fluids:** comparators read a tank column's fill level ([8a5d075](https://github.com/Indemnity83/logistics/commit/8a5d075241d64565903269922deae03374b73184))
* **quarry:** keep the cleared area clear while mining ([d27afbd](https://github.com/Indemnity83/logistics/commit/d27afbd2982fa1cfc29cd41491f62b1c60c2e8b5))
* **quarry:** rebuild frame blocks broken during mining ([d27afbd](https://github.com/Indemnity83/logistics/commit/d27afbd2982fa1cfc29cd41491f62b1c60c2e8b5))
* **routing:** recover stranded packets onto live orders ([3e8510f](https://github.com/Indemnity83/logistics/commit/3e8510f8b525092a128c520805f2e0f9291e7c69))


### Changed

* **automation:** require a stone pickaxe for the Quarry and Power Junction ([5d3b3fd](https://github.com/Indemnity83/logistics/commit/5d3b3fd8ab393c55d0480dca357f88be8ece93b2))
* **energy:** scan cable devices once per tick ([25fac90](https://github.com/Indemnity83/logistics/commit/25fac90a98bb5d72af7d40f5f9df80861301c838))
* **routing:** protect the Provider's named slot by index ([cfdaca1](https://github.com/Indemnity83/logistics/commit/cfdaca1736dc5823cd61277afffcc377bfe0486a))
* **routing:** stop availability scans slowing as reservations pile up ([7f250d8](https://github.com/Indemnity83/logistics/commit/7f250d88a13c7f83a88fe89ffcd0df0d35889082))


### Fixed

* **automation:** scale the Crucible gauge by the server's tank size ([909c8b8](https://github.com/Indemnity83/logistics/commit/909c8b86b181ce31d1f97f77f713e6c8d5832000))
* **common:** stop pickaxes destroying blocks they should harvest ([5d3b3fd](https://github.com/Indemnity83/logistics/commit/5d3b3fd8ab393c55d0480dca357f88be8ece93b2))
* **crafting:** report a malformed byproduct chance as a recipe error ([ca9c6b7](https://github.com/Indemnity83/logistics/commit/ca9c6b7667a256a14146140e5707c58b1a3dddb5))
* **energy:** power the new network right after a pipe split ([3507c8d](https://github.com/Indemnity83/logistics/commit/3507c8df04c2e8b7966c0cea15a03a2a2112dd19))
* **energy:** scale the Stirling charge gauge to the buffer size ([3611e37](https://github.com/Indemnity83/logistics/commit/3611e37a33e917c02251f425e6ee42285cbd084c))
* **energy:** stop batteries draining each other ([#1242](https://github.com/Indemnity83/logistics/issues/1242)) ([3cb5b5c](https://github.com/Indemnity83/logistics/commit/3cb5b5cbc88f07ac7aacae3aa44a513d636f299b))
* **energy:** stop cables drawing a wrong connection arm ([0bd281e](https://github.com/Indemnity83/logistics/commit/0bd281eaaf306640ca37d8d33ea26664539e4f46))
* **fluids:** show correct tank amounts above 32,767 mB ([1020ff9](https://github.com/Indemnity83/logistics/commit/1020ff917f3b5fbb7a909118e00da6bdcbb98d17))
* **neoforge:** report a wrapped mod inventory's real slot capacity ([b001e36](https://github.com/Indemnity83/logistics/commit/b001e363b6ffcd78a880eb7b7fe1e98aee51b48b))
* **quarry:** animate the arm at the real tick rate ([da61128](https://github.com/Indemnity83/logistics/commit/da61128d57a197eb76196115d3cefbf02de75393))
* **quarry:** pick up loose items around the laser head ([#1241](https://github.com/Indemnity83/logistics/issues/1241)) ([d0e3097](https://github.com/Indemnity83/logistics/commit/d0e3097fc48d70a20bbb8430ff7e3abc9c24e66b))
* **quarry:** resume block break progress after a reload ([3941f34](https://github.com/Indemnity83/logistics/commit/3941f3456b4882ff5993a43eb0f8fc20ca8e0c60))
* **routing:** send items and fluids to the nearest matching destination ([491604c](https://github.com/Indemnity83/logistics/commit/491604c286af2346a93cb3248ac13e01d018661e))
* **ui:** refresh machine textures after a resource reload ([#1191](https://github.com/Indemnity83/logistics/issues/1191)) ([d18f781](https://github.com/Indemnity83/logistics/commit/d18f781ca35f1e9423c2c8ec910e44713adc935b))
* **ui:** show the server's config values on multiplayer clients ([9c6d431](https://github.com/Indemnity83/logistics/commit/9c6d43160e441f245e4e72120d47d401ba31a4df))
* **worldgen:** speckle the whole oil seep bank on 1.21.x ([#1189](https://github.com/Indemnity83/logistics/issues/1189)) ([3a8ed07](https://github.com/Indemnity83/logistics/commit/3a8ed07f9cfa265d94e89d097580cd9f1151741d))
* **worldgen:** stop oil seeps erasing nearby oil deposits ([#1180](https://github.com/Indemnity83/logistics/issues/1180)) ([02f7e10](https://github.com/Indemnity83/logistics/commit/02f7e100a197f83e2a9fea71214e68dbdd83d81b))

## [0.8.8](https://github.com/Indemnity83/logistics/compare/mc1.21.11-v0.8.7...mc1.21.11-v0.8.8) (2026-09-09)


### Changed

* **energy:** stop idle engines resaving their chunks every tick ([3a82071](https://github.com/Indemnity83/logistics/commit/3a82071eb71170e65cfff16613b9608ea6bcef96))
* **fluids:** stop tank columns rewriting cells that did not change ([3a82071](https://github.com/Indemnity83/logistics/commit/3a82071eb71170e65cfff16613b9608ea6bcef96))
* **routing:** make the MkIII Extractor a real upgrade ([abe0a40](https://github.com/Indemnity83/logistics/commit/abe0a40c29b7e0bb7f36f888bbc5d29d328c1e1b))
* **routing:** rank specific Item Sinks above Polymorphic ([925518f](https://github.com/Indemnity83/logistics/commit/925518fcffe30076e3bad3ad331833f9ce2b9bd4))
...
* **automation:** let a stalled Fabricator order be cancelled ([6933bc0](https://github.com/Indemnity83/logistics/commit/6933bc068bd54b22643d7e6f8a91f4239c501aa8))
* **automation:** stop a new quarry inheriting the old one's arm position ([07da556](https://github.com/Indemnity83/logistics/commit/07da5564d7d557608510ac74ca4c8ed7b3540e5f))
* **automation:** stop machines jamming on items they cannot use ([7853936](https://github.com/Indemnity83/logistics/commit/78539360b34f1bf223eda63a52f48e3a9f090c37))
...
* **automation:** stop the Fabricator eating a failed craft ([5eaed00](https://github.com/Indemnity83/logistics/commit/5eaed00c1a0fef6ce26555ec779c732802f6640d))
...
* **core:** reject config values that silently brick a machine ([5e6a698](https://github.com/Indemnity83/logistics/commit/5e6a698db2c2f9410c6d452c81449cc67b8e60a8))
...
* **energy:** hold the battery's per-side push to its own I/O ceiling ([5e6a698](https://github.com/Indemnity83/logistics/commit/5e6a698db2c2f9410c6d452c81449cc67b8e60a8)), closes [#992](https://github.com/Indemnity83/logistics/issues/992) [#982](https://github.com/Indemnity83/logistics/issues/982) [#995](https://github.com/Indemnity83/logistics/issues/995) [#1000](https://github.com/Indemnity83/logistics/issues/1000)
...
* **energy:** stop a legal steam config making RF free ([5e6a698](https://github.com/Indemnity83/logistics/commit/5e6a698db2c2f9410c6d452c81449cc67b8e60a8))
* **energy:** stop a new engine resuming the old one's piston stroke ([07da556](https://github.com/Indemnity83/logistics/commit/07da5564d7d557608510ac74ca4c8ed7b3540e5f)), closes [#976](https://github.com/Indemnity83/logistics/issues/976) [#988](https://github.com/Indemnity83/logistics/issues/988)
* **energy:** stop cables exceeding their throughput cap ([9de83ab](https://github.com/Indemnity83/logistics/commit/9de83abc4d18113fb11ba54bb63663fa3a1e6ba6))
...
* **energy:** stop the Magmatic Engine locking itself out of ignition ([5e6a698](https://github.com/Indemnity83/logistics/commit/5e6a698db2c2f9410c6d452c81449cc67b8e60a8))
...
* **pipes:** re-request deliveries that time out in transit ([0adbd4a](https://github.com/Indemnity83/logistics/commit/0adbd4a10dfa965ba96c9c12e62d41de91ecb47f))
...
* **routing:** detach chassis modules shift-clicked out ([490bb20](https://github.com/Indemnity83/logistics/commit/490bb20032da4241469f65a3fb0731d301a60bc8))
...
* **routing:** keep chassis sinks working after a network split ([e948744](https://github.com/Indemnity83/logistics/commit/e9487441e33cd843e7b675aff1ae8a32c8e4e425))
* **routing:** make tied sink priorities pick a stable destination ([925518f](https://github.com/Indemnity83/logistics/commit/925518fcffe30076e3bad3ad331833f9ce2b9bd4))
...
* **routing:** stop Providers draining the slot they reserve ([77963c1](https://github.com/Indemnity83/logistics/commit/77963c1bc339e24ca22e793eaf79bea114240d3d))
* **routing:** stop Supplier slots editing the wrong entry ([a30c07c](https://github.com/Indemnity83/logistics/commit/a30c07c15db0b7df377c9d2b0b2a74d7775cd0a1))
* **routing:** stop Suppliers forgetting their stock target ([af28e7d](https://github.com/Indemnity83/logistics/commit/af28e7d36aecab14dd6d1bda88dab38aee0e4525))
* **routing:** stop the MkIII Extractor pulling less than the MkII ([abe0a40](https://github.com/Indemnity83/logistics/commit/abe0a40c29b7e0bb7f36f888bbc5d29d328c1e1b))
...
* **storage:** report a real item capacity to other mods ([82d3490](https://github.com/Indemnity83/logistics/commit/82d3490d2ad2514f4ebfed8aa7577ab3833b8359)), closes [#985](https://github.com/Indemnity83/logistics/issues/985) [#986](https://github.com/Indemnity83/logistics/issues/986) [#990](https://github.com/Indemnity83/logistics/issues/990)
* **transport:** apply config reloads to stone and gold pipes ([3cafb2b](https://github.com/Indemnity83/logistics/commit/3cafb2b34d4145ad1220cab6159e3558d8ee30ab))
...
* **ui:** close machine screens when the machine is gone ([534feef](https://github.com/Indemnity83/logistics/commit/534feef3f5151d3de22cd3991d3c361510f5a03e))
* **ui:** show byproduct guaranteed count in JEI ([9dcc8a6](https://github.com/Indemnity83/logistics/commit/9dcc8a6fc3bbc24b907aab2eb71bca54270fd2cf))
* **ui:** stop listing every automation recipe twice in JEI ([7796911](https://github.com/Indemnity83/logistics/commit/7796911facdd2995ad4fd73d54c59830217197a2))
